...
<body>
	...
	<div class="main-body single-service-bg">
		<div class="reserve-book-area">
			<div class="formdesign">
			<h2>Library Member</h2>
				<table>
					<tr>
						<form action="ViewLibraryMember" method="get">
						<td><input type="submit" value="View Library Member"
							class="viewlibrarymember "></td>
						</form>
						<td></td>
						<td><button class="deletemember">
				...
				<table>
					<form action="LibraryMember" method="post">
					<tr>
						<td><label for="id">ID:</label></td>
						<td><input type="text" id="id" name="id"
							placeholder="Member Id"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="text" id="position" name="position"
							placeholder="Member Position"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="date" id="joiningdate" name="joiningdate"></td>
					</tr>
