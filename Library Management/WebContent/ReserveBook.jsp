	...
	<div class="main-body single-service-bg">
		<div class="reserve-book-area ">
			...
			<h2>Reserve Book</h2>
				<table>
					<tr>
						<form action="ViewReserveBook" method="get">
							<td><input class="viewissuebook" type="submit"
								value="View Reserve Book" name="btn"></td>
						</form>
						<form action="SearchReserveBook" method="get">
				...
				<table>
					<form action="ReserveBook" method="post">
						<tr>
							<td><label for="bname">Book ID:</label></td>
							<td><input type="text" id="bname" name="bookid"
						...
						<tr class="submitclass">
							<td><input type="submit" value="Save" name="btn"></td>
						</tr>
					</form>
				</table>
